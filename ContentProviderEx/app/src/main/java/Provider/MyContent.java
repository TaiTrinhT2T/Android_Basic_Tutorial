...
public class MyContent extends ContentProvider{
	...
	public static final String PROVIDER_NAME = "com.provider.example";
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        case STUDENTS:
            ...
            break;
        case STUDENTS_ID:
            count = db.delete(STUDENTS_TABLE_NAME, ID + "=" + uri.getPathSegments().get(1) +
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
        case STUDENTS:
            return "vnd.android.cursor.dir/com.tav.students";
        case STUDENTS_ID:
            return "vnd.android.cusor.item/com.tav.students";
        default:
